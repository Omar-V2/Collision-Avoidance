...
while running:
	...
	angled_sensor1_end = (
	center[0] + (radius + sensor_range) * cos(pi / 6), center[1] - (radius + sensor_range) * sin(pi / 6))
	...
	pygame.draw.line(screen, (255, 0, 0), (center[0] + radius, center[1]),
	                 (center[0] + (radius + sensor_range), center[1]), 1)
